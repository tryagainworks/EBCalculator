...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dlgSettings_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dlgSettings_t qt_meta_stringdata_dlgSettings = {
    {
QT_MOC_LITERAL(0, 0, 11), // "dlgSettings"
QT_MOC_LITERAL(1, 12, 23), // "on_dlgSettings_rejected"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 18) // "on_cmdBack_clicked"

    },
    "dlgSettings\0on_dlgSettings_rejected\0"
    "\0on_cmdBack_clicked"
};
...
void dlgSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_dlgSettings_rejected(); break;
...
void *dlgSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dlgSettings.stringdata))
